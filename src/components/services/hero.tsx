...
export function Hero() {
  return (
    <section className='pt-32 pb-20 bg-linear-to-br from-accent/20 via-accent/10 to-secondary'>
      ...
      >
        <TagBadge label='What We Do Best' icon='Handshake' className='mb-4' />
        <motion.h1 variants={itemVariants}>Services Built for Growth</motion.h1>
        <motion.p variants={itemVariants} className='max-w-2xl md:max-w-3xl'>
          ...
          transformation and maximize your competitive advantage in the market.
        </motion.p>
      </motion.div>
    </section>
  )
